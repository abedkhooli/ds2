...
#---------------------------------------------- AK: num_gpus = 2 instead of 8 to avoid "invalid device ordinal" error
...
DATASET=content/hdf5_1 # Phase 1 change this for other datasets (system adds first /)
...
DATASET=content/hdf5_2 # # Phase 2 change this for other datasets (system adds first /)
